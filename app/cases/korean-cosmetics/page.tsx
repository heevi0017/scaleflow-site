...
export const metadata = {
  title: "Кейс: Магазин корейской косметики | ScaleFlow",
  description: "Как мы выросли с $30k до $120k/мес для магазина корейской косметики в США.",
}
  ...
  return (
    <main className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-6 py-20">
        ...
        <h1 className="text-4xl md:text-6xl font-bold mb-6">Магазин корейской косметики (США)</h1>
        <p className="text-xl text-white/60 mb-8">
          с $30k до $120k/мес - рост выручки
        </p>
